			...
			<ul class="list-unstyled components">
				...
				<li class="nav-level-one">
					...
					<ul class="list-unstyled collapse" aria-expanded="true" id="nav-uiKit">
						<li>
							<a href="typography.html"> ADD CUSTOMER</a>
						</li>
						<li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<!-- Form It
								em -->
							<h3 class="widget-title">ADD ITEMS</h3>
							<div class="lorvens-widget">
								<form action="add_item_backend.php" method="POST">
									<div class="form-group">
									...
									<button type="submit" name="Submit" class="btn btn-primary">ADD_ITEM</button>
								</form>
							</div>
						
						<div class="col-md-12">
						<div class="widget-area-2 lorvens-box-shadow">
							<h3 class="widget-title">ITEM_AVAILABLE</h3>
							...
							<div class="table-div">
								<table class="table table-hover">
									...
									<tbody>
									  ...
									  echo "<tr><td>".$row1["SR_NO"]."</td><td>".$row1["NAME"]."</td></tr>";
									}
									  ?>
